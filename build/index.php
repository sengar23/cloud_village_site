         ...
         <div class="tab-content r-mb-12">
            <div role="tabpanel" class="tab-pane fade in active" id="category-1">
               <div class="panel-group talks-panel-group" id="accordion-1" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="panel-body">
                           <div class="item">
                              <div class="services__item">
                                 ...
                                 <p class="services__item__text"><strong class="white">Abstract: </strong>The cloud is compelling and in many cases necessary for organizations to effectively operate. </p>
                                 <p class="services__item__text">Cloud security on the other hand is not as clear. Many cloud services need a hook into the on-premises environment in order to synchronize users and groups. Additionally, the cloud security controls vary by provider in availability, capability, and cost. This results in a disjointed view of user authentication, security, and potential configuration issues.</p>
                                 <p class="services__item__text">This talk explores some common cloud configuration scenarios and the associated security issues.</p>
                                 <p class="services__item__text"><strong class="white">About Sean: </strong>Sean Metcalf is founder and principal consultant at Trimarc (www.TrimarcSecurity.com), a professional services company which focuses on improving enterprise security. He is one of about 100 people in the world who holds the Microsoft Certified Master Directory Services (MCM) certification, is a Microsoft MVP, and has presented on Active Directory & Microsoft Cloud attack and defense at Black Hat, BSides, DEF CON, DerbyCon, Microsoft BlueHat, Shakacon and Walmart Sp4rkCon security conferences. He currently provides security consulting services to customers and posts interesting Active Directory security information on his blog, ADSecurity.org</p>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="panel-body">
                           <div class="item">
                              <div class="services__item">
                                 ...
                                 <p class="services__item__text"><strong class="white">About Colin: </strong>Currently a threat researcher at Netskope focused on AWS and GCP. Colin was previously the CSO at Sift Security (acquired by Netskope), where he helped move the product towards breach detection for IaaS. He was a senior engineer on the security teams at Netflix and Apple before joining Sift. He was also a FBI Agent specializing in Cyber crime, where he spent a fair amount of time coordinating with other countries to locate and arrest malware authors and botnet operators.</p>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="panel-body">
                           <div class="item">
                              <div class="services__item">
                                 ...
                                 <p class="services__item__text"><strong class="white">Abstract: </strong>In this talk I will share my experience about how I hacked different automotive clouds, techniques I used and goals I pursue after connecting. </p>
                                 ...
                                 <p class="services__item__text"><strong class="white">About Rotem: </strong>I work in the automotive field for about 4 years now, Started my way with red-teaming production plants and different cloud providers with the goal of getting as deep as possible and showing full impact.I love breaking stuff, especially when its in mass scale. taking control over entire systems and seeing my clients in awe and shock as I give them live annotations of what I'm doing to them.</p>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="panel-body">
                           <div class="item">
                              <div class="services__item">
                                 ...
                                 <p class="services__item__text"><strong class="white">Abstract: </strong>Containers,Cloud,DevOps and SDLC are all terms that are increasing in terms of usage in the InfoSec world. In this talk, we discuss how a container exploitation tool (BOtB) was developed to identify and autopwn common vulnerabilities in container technologies such as Docker and LXC and how this tool was used in a modern SDLC environment using common CI/CD technologies to identify, exploit and remediate container vulnerabilities before releases were made to production. </p>
                        ...
                        <div class="panel-body">
                           <div class="item">
                              <div class="services__item">
                                 ...
                                 <p class="services__item__text"><strong class="white">About Erick: </strong>Erick is a security researcher at Netskope focused on malicious SaaS usage and attacks against Microsoft Azure. He previously was previously at Cisco's Talos group where he focused on hunting exploit kits. As part of his academic research at Johns Hopkins University, he conducts research on neural networks, verifiable computing, and computational complexity.</p>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="panel panel-default">
                     <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-1" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                  ...
                  <div class="panel panel-default">
                     <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-1" href="#collapseSponsor" aria-expanded="false" aria-controls="collapseSponsor">
                        <div class="panel-heading" role="tab" id="headingSponsor">
                           <h4 class="panel-title"> Sponsored Talk - Anatomy of cloud hacking </h4>
                           <div class="plus-sym"></div>
                        </div>
                     </a>
                     <div id="collapseSponsor" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSponsor">
                        <div class="panel-body">
                           <div class="item">
                              <div class="services__item">
                                 <p class="purple"><strong class="white">Speaker:&nbsp;</strong><strong>Pratik Shah</strong></p>
                                 <!--<p class="green"><strong class="white">Date:&nbsp;</strong><strong>TBA</strong></p><p class="green"><strong class="white">Time:&nbsp;</strong><strong>TBA</strong></p>--> 
                                 <p class="purple"><strong class="white">Twitter:&nbsp;</strong><a href="https://twitter.com/7echsec" target="_blank"><strong>@7echSec</strong></a></p>
                                 <p class="services__item__text"><strong class="white">Abstract: </strong> This talk familiarize the attendees with different techniques and approach of cloud hacking. We will start from the very basic and gradually build-up to the level where we will look into different cloud architecture and common issues/misconfigurations identified in them. The complete focus of this talk would be to explain cloud hacking methodology and cover well-known attacks around the cloud infrastructure. </p>
                                 <p class="services__item__text">In this talk, we will discuss some interesting case studies and we'll understand the root cause. We will also talk about different techniques which can lead to gaining an initial foothold and then we will look into multiple post-exploitation techniques.</p>
                                 <p class="services__item__text"><strong class="white">About Pratik: </strong>Pratik is an information security enthusiast with a strong interest in infrastructure penetration testing, web application security assessments and cloud penetration testing, which has led to extensive penetration testing experience for Fortune 500 companies involving web applications, networks, Infra, and Red Team. Pratik took part in multiple Bug Bounty programs and in over the years he has reported multiple vulnerabilities through HackerOne, Synack Red Team, and Cobalt Core. He has also contributed to Metasploit exploit development (written exploit for Windows local privilege escalation).</p>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="panel panel-default">
                     <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-1" href="#collapseTanya" aria-expanded="false" aria-controls="collapseTanya">
                        ...
                        <div class="panel-body">
                           <div class="item">
                              <div class="services__item">
                                 ...
                                 <p class="services__item__text"><strong class="white">Abstract: </strong>I'll explore the limitations of temporary tokens including:
                                 </p>
                                 <ul class="custom-list">
                                    <li class="white">The lack of visibility/management</li>
                                    <li class="white">Minimal logging</li>
                                    <li class="white">Limited remediation options</li>
                                    <li class="white">How this can be taken advantage of, especially in combination with other techniques such as assuming of roles, pre-signed URLs, log attacks, and serverless functions to achieve persistence, lateral movement, and obfuscation.</li>
                                 ...
                                 <p class="services__item__text"><strong class="white">About Jenko: </strong>Jenko Hwong is on the Security Research Team at Netskope, focusing on cloud threats/vectors. He's spent time in engineering and product at a few too many security startups in vulnerability scanning, AV/AS, pen-testing/exploits, L3/4 appliances, threat intel, and windows security.</p>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="panel panel-default">
                     <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-1" href="#collapseYeoh" aria-expanded="false" aria-controls="collapseYeoh">
                        <div class="panel-heading" role="tab" id="headingYeoh">
                           <h4 class="panel-title">The Effectiveness Of Continuous Bug Hunting In Cloud Environments </h4>
                           <div class="plus-sym"></div>
                        </div>
                     </a>
                     <div id="collapseYeoh" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingYeoh">
                        <div class="panel-body">
                           <div class="item">
                              <div class="services__item">
                                 <p class="purple"><strong class="white">Speaker 1:&nbsp;</strong><strong>Michael Gianarakis</strong></p>
                                 
                                 <p class="purple"><strong class="white">Twitter:&nbsp;</strong><a href="https://twitter.com/mgianarakis" target="_blank"><strong>@mgianarakis</strong></a></p>
                                 <p class="purple"><strong class="white">Speaker 2:&nbsp;</strong><strong>Sean Yeoh</strong></p>
                                 ...
                                 <p class="services__item__text"><strong class="white">About Michael: </strong>Michael has presented at various industry events and meetups including DEF CON, Black Hat Asia, Thotcon, 44Con and Hack in the Box. Michael is also actively involved in the local security community in Australia where he is one of organizers of the monthly SecTalks meetup as well as the hacker camp TuskCon. </p>
                                 <p class="services__item__text"><strong class="white">About Sean: </strong>Sean Yeoh is the Lead Architecture and DevOps engineer at Assetnote, ensuring that the build is continuously broken and logging of the engine is too verbose. Sean previously participating religiously in CTFs as part of his University CTF team, winning the past two Cyber Security Challenge Australia CTFs. He lectures Advanced Web Application Security and Software Security Assessment (Formerly 9447) at UNSW and spends his free time doing bug bounties and wrangling kubernetes.</p>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="panel-body">
                           <div class="item">
                              <div class="services__item">
                                 ...
                                 <p class="services__item__text"><strong class="white">About Setu: </strong>Cloud Security Architect with specialization towards defense in depth and incident response in cloud. </p>
                              </div>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="panel-body">
                           <div class="item">
                              <div class="services__item">
                                 ...
                                 <p class="services__item__text"><strong class="white">Abstract: </strong>Learn about a breach, what happens in the aftermath and why I can't tell my peers what happen. Learn the fallout and more importantly what application developers aren't thinking about. </p>
                                 <p class="services__item__text"><strong class="white">About Jane: </strong>Enterprise Cloud Architect, 9 years exp in cloud, former lead cloud SRE </p>
                              </div>
                           </div>
                        </div>
                     </div>
