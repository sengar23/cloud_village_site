...
<head>
    ...
    <meta property="og:description" content="An open space to meet folks interested in offensive and defensive aspects of cloud security.">
    ...
    <link href="https://fonts.googleapis.com/css?family=Montserrat:500|Source+Code+Pro:300,400,400i,600,700" rel="stylesheet">
...
<body>
    ...
    <header class="header">
        <div class="inner-header container">
            <div class="header__logo"> <a href="index.html" class="logo__item"></a> </div><button class="btn_nav"><i class="icon-menu"></i></button>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="about__text col-xs-12 col-md-12">
                    <h2 class="text__header">Call for Papers (DEF CON 27)</h2> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeGxSDgynvAv7Q1dTPeobZUPo5jdlbrcNSQAYVLgRqCF6T0bg/viewform" target="_blank" class="text__button cta" title="CFP for DEF CON 27">CFP Submission Form</a>
                    ...
                    </ul> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeGxSDgynvAv7Q1dTPeobZUPo5jdlbrcNSQAYVLgRqCF6T0bg/viewform" target="_blank" class="text__button inline-btn" title="CFP for DEF CON 27">CFP Submission Form</a>
                </div>
            </div>
        </div>
    </section><!-- Section CTF*****************************-->
        ...
        <div class="container">
            <div class="row">
                <div class="about__text col-xs-12 col-md-12">
                    ...
                    <p class="text__par">Cloud village is an open space to meet folks interested in offensive and defensive aspects of cloud security. The village is home to various activities like talks, workshops, CTFs and discussions targeted around cloud services. </p>
                    <p class="text__par"> If you are a professional who is looking to gain knowledge on securely maintaining the cloud stack and loves to be around like-minded security folks who share the similar zeal towards the community, Cloud Village is the perfect place for you. </p>
    ...
    <section id="talks" class="talks section">
        <div class="container">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#category-1" aria-controls="category-1" role="tab" data-toggle="tab">Talks(<span class="ca-count"></span>)</a></li>
                <li role="presentation"><a href="#category-2" aria-controls="category-2" role="tab" data-toggle="tab">Workshops(<span class="ca-count"></span>)</a></li>
                <li role="presentation"><a href="#category-3" aria-controls="category-3" role="tab" data-toggle="tab">Tool Demo(<span class="ca-count"></span>)</a> </li>
                <li role="presentation"><a href="#category-4" aria-controls="category-4" role="tab" data-toggle="tab">Lightning Talks(<span class="ca-count"></span>)</a> </li>
            </ul>
            <div class="tab-content r-mb-12">
                <div role="tabpanel" class="tab-pane fade in active" id="category-1">
                    <div class="panel-group talks-panel-group" id="accordion-1" role="tablist" aria-multiselectable="true">
                        <div class="panel panel-default"> <a class="panel-btn" role="button" data-toggle="collapse" data-parent="#accordion-1" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                ...
                                <div class="panel-body">
                                    <div class="item">
                                        <div class="services__item">
                                            ...
                                            <!--<p class="purple"><strong class="white">Date:&nbsp;</strong><strong>TBA</strong></p><p class="purple"><strong class="white">Time:&nbsp;</strong><strong>TBA</strong></p>-->
                                            <p class="purple"><strong class="white">Twitter:&nbsp;</strong><a href="https://twitter.com/rotembar" target="_blank"><strong>@rotembar</strong></a></p>
                                            <p class="white"><strong class="white">Abstract:&nbsp;</strong></p>
                                            <p class="services__item__text">In this talk I will share my experience about how I hacked different automotive clouds, techniques I used and goals I pursue after connecting. </p>
                                            ...
                                            <p class="services__item__text">I will talk about the main connectivity areas I look for, supplier integrations and differences between normal clouds and automotive clouds. Once I got a good foothold, Possible targets and places which can harm the most. Where can I jump next inside and how deep the rabbit hole goes.</p>
                                            <p class="services__item__text"> This will be a technical talk going into places I've experienced personally in the last few years and will try to give a glimpse of the fun life of hacking into the vehicle ecosystem </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default"> <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-1" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                ...
                                <div class="panel-body">
                                    <div class="item">
                                        <div class="services__item">
                                            ...
                                            <p class="services__item__text">Containers,Cloud,DevOps and SDLC are all terms that are increasing in terms of usage in the InfoSec world. In this talk, we discuss how a container exploitation tool (BOtB) was developed to identify and autopwn common vulnerabilities in container technologies such as Docker and LXC and how this tool was used in a modern SDLC environment using common CI/CD technologies to identify, exploit and remediate container vulnerabilities before releases were made to production. </p>
                                            <p class="services__item__text">In this talk we elaborate on how and why BOtB was built to be used by pentesters to exploit container vulnerabilities and how BOtB can be used by engineers to secure their container environments. The talk will also explain the technical details around the vulnerabilities that can be exploited by BOtB.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default"> <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-1" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                ...
                                <div class="panel-body">
                                    <div class="item">
                                        <div class="services__item">
                                            ...
                                            <p class="services__item__text">What happens when attackers start taking advantage of whitelisted APIs as a form of obfuscated command and control? Companies both large and small are moving workloads to the cloud and are very concerned with how to secure their resources which actually live in AWS, GCP, and Azure. However, they don't address how enabling this access changes their internal attack surface and weakens their defenses. </p>
                                            <p class="services__item__text">In this talk, we demonstrate that attackers no longer have any reason to rely on conventional CNC, being able to outsource their costs and infrastructure management to the likes of Slack, Github, Pastebin, Dropbox, Google, and social media sites. Using these sorts of techniques, URL blacklisting becomes obsolete, IDS becomes less effective, and attackers no longer have to waste their time writing domain generation algorithms.</p>
                                            <p class="services__item__text">Specifically, I will demo a proof-of-concept malware which uses multiple SaaS services, social networks, and more conventional "cloud infrastructure" (S3) that would be extremely difficult to mitigate generically with today's IPS solutions, and we discuss how the same techniques can be used by red teams and attackers to quietly maintain persistence and exfiltrate data.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default"> <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-1" href="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                <div class="panel-heading" role="tab" id="headingFive">
                                    <h4 class="panel-title"> Applying Pareto's Principle for Securing AWS with SCPs </h4>
                                    <div class="plus-sym"></div>
                                </div>
                            </a>
                                ...
                                <div class="panel-body">
                                    <div class="item">
                                        <div class="services__item">
                                            ...
                                            <!--<p class="green"><strong class="white">Date:&nbsp;</strong><strong>TBA</strong></p><p class="green"><strong class="white">Time:&nbsp;</strong><strong>TBA</strong></p>-->
                                            <p class="purple"><strong class="white">Twitter:&nbsp;</strong><a href="https://twitter.com/coffeewithayman" target="_blank"><strong>@coffeewithayman</strong></a></p>
                                            <p class="services__item__text">In this talk I am going to walk through how we can use pareto's principle to secure all our AWS accounts. What this means is with just 20% of effort, we can accomplish 80% security of our AWS accounts. We will be leveraging the power of AWS Organizations and IAM to accomplish our goals. This will be a technical talk and guide on how to secure your account. </p>
                        ...
                        <div class="panel panel-default"> <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-1" href="#collapseDani" aria-expanded="false" aria-controls="collapseDani">
                        ...
                        <div class="panel panel-default"> <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-1" href="#collapseTanya" aria-expanded="false" aria-controls="collapseTanya">
                                <div class="panel-heading" role="tab" id="headingTanya">
                                    <h4 class="panel-title"> DYI Azure Security Assessment </h4>
                                    <div class="plus-sym"></div>
                                </div>
                            </a>
                        ...
                        <div class="panel panel-default"> <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-1" href="#collapseRod" aria-expanded="false" aria-controls="collapseRod">
                                <div class="panel-heading" role="tab" id="headingRod">
                                    <h4 class="panel-title"> Using Splunk for Auditing AWS/GCP/Azure Security posture </h4>
                                    <div class="plus-sym"></div>
                                </div>
                            </a>
                                ...
                                <div class="panel-body">
                                    <div class="item">
                                        <div class="services__item">
                                            ...
                                            <p class="services__item__text"> Cloud. It's the land of opportunity. Enterprises are doing mass migrations from older and legacy systems to harness greater power and efficiency from innovative new tech. Following that money trail are opportunistic attackers, seeking the computing strength and near-invisibility afforded by enterprise cloud environments to mine bitcoin. Cryptominers are everywhere. And yes, Virginia, they are in the Cloud.<br>These nebulous power-rich realms let attackers set up mining rigs to feast on enterprise resources, while flying below the detection of cloud or conventional security resources. The concern here is that once attackers gain access to our networks, they can pivot and move laterally, to find even greater reward in the vast amounts of data available. Let's talk about what we do and don't know when it comes to securing our cloud environments against malicious miners. Because it isn't just a question of what they can take – it's about the payloads they can leave behind. <br>Introduction: (5 min)<br>• Enterprise and Cloud: If you work for a major organization, you're probably undergoing or have just gone through a major migration to the Cloud. This is the big push according to a recent Gartner report, with 37% of enterprises reporting it as their top priority, and ranking at 39% for CIOs, ahead of cybersecurity (why are we not surprised).<br>• An Evolution of Evil: the rise of miners. Easy to get into. Low bar for entry. Starter toolkits cost $30 online. Cryptojacking increased by 4000% in 2018. <br>• Major miners like XMRig<br>• Main attack vectors: brute force credentials for access; leverage multiple vulnerabilities for access and movement internally.<br>• Motivation: almost 100% return on investment. No overhead <br>Miners in the Sky: (5 min)<br>• Why it's expected to continue<br>o The return on investment is lucrative in terms of computing power <br>o Lack of detection<br>• Most organizations don't have mature cloud security programs. By design, yes, in reality – not so much. Cloud has huge amounts of processing power with built-in auto-scaling<br>• attackers can operate with almost no detection <br>• The bigger the account, the longer attackers can go<br>• Enterprises are migrating to the Cloud. We love our containers: Docker, AWS, Azure. <br>Charting the rise of malicious miners in cloud environments by attacks: (10 min)<br>Overview of what we're seeing:<br>• attacks on containers and container management<br>• control panel exploitation<br>• theft of APIs<br>• spreading malicious Docker images<br>• leveraging current and older enterprise vulnerabilities<br>• EternalBlue<br>Let's Start Here: The attack on Tesla's AWS S3 public cloud in February 2018. Researchers at RedLock found mining malware from a wide-spread, well-concealed cryptomining campaign in Tesla's AWS cloud. RedLock found it when they scanned public internet for misconfigured and unsecured cloud servers – there's been a few of those. They saw an open server. Further investigation revealed it was running Kubernetes, the open source admin console for cloud application mgmt., which was doing cryptomining. The Kubernetes console was not password protected. The attackers found login credentials for Tesla's AWS in one of the pods. They went from there to deploy malware scripts for Stratum bitcoin mining.<br>Abusing exposed Docker APIs: Hundreds of vulnerable and exposed Docker hosts were abused in cryptojacking campaigns in March this year. Attackers exploited CVE-2019-5736, a runc vulnerability identified in February, that could trigger a container escape. Now, that kind of defeats the whole purpose of having a container when it means the attacker can access the host filesystem and overwrite the runc binary to run arbitrary commands on the host. Attackers scan for exposed Docker APIs on port 2375. They deployed malicious self-propagating Docker images infected with malware to load Monero miners and find other vulnerable targets via Shodan. External access to API ports will enable attackers to gain ownership of the host. They can tamper with instances running inside, drop malware, access user's servers and resources. Discussion point: Misconfiguration is prevalent – why? How can we help users do this better?<br>Uninstalling Cloud Security: A new cryptomining malware family that targets Linux servers gained admin rights on systems by uninstalling cloud security products. We'll talk about the Chinese-language threat actor behind this and other attacks, Rocke group. Consider how nation-state adversaries and advanced persistent threats (APTs) could seek to leverage this kind of attack in sophisticated campaigns.<br>Discussion point: We've seen conventional malware evade and disable existing AV. If we can't detect it, how do we protect against it? How are we extending this to malware targeting Cloud?<br>Targeting Elasticsearch servers: in the “Cryptosink” campaign, attackers exploit a five year old vulnerability that could lead to executing arbitrary Java code, CVE-2014-3120, that affects Elasticsearch running on both Windows and Linux platforms. They download malware that has not been detected by AV on Linux. The attackers backdoor the servers for future access, eliminate competitors on the infected system by redirecting their mining pool traffic to a sinkhole, and achieve persistence by replacing the Linux remove command. <br>What else could be at risk: Abusing instant metadata API. This functionality is offered by all cloud providers. If it isn't secured or monitored well, and attacker can exploit it via vulnerable reverse proxies or malicious Docker images.<br>What could this lead to: Once attackers are in your network, they aren't limited to just mining Monero. They have access to all your data-rich environments. If the attacker is looking for satisfaction that money can't buy, yes they can deliver a very damaging payload with ransomware or worse. Think NotPetya. <br>Review of Vulnerabilities & Exploits: (5 min)<br>• Misconfiguration: security researcher and attackers are actively seeking and finding many exposed and unsecured instances online. Human error is at the brunt of things, but Cloud isn't traditional infrastructure. It's a complex, dynamic network that requires specialized knowledge and training to do configuration right. <br>• EternalBlue: believe it. There are still plenty of unpatched instances out there and attackers continue to leverage this exploit to gain access, spread and move laterally within networks<br>• Oracle WebLogic vulnerability CVE-2019-2725: There have been a series of critical vulnerabilities in this popular enterprise software<br>• Remote code execution: Miners have been using a group of vulnerabilities for RCE as initial access and more<br>o CVE-2012-0874: JBoss Enterprise Application Platform Multiple Security Bypass Vulnerabilities.<br>o CVE-2010-1871: JBoss Seam Framework <br>o JBoss AS 3/4/5/6: CVE-2017-10271: Oracle WebLogic wls-wsat Component Deserialization RCE<br>o CVE-2018-2894: Vulnerability in the Oracle WebLogic Server component of Oracle Fusion Middleware.<br>o Hadoop YARN ResourceManager - Command Execution<br>o CVE-2016-3088: Apache ActiveMQ Fileserver File Upload<br>• PSMiner targets known vulnerabilities in Elasticsearch, Hadoop, PHP, Oracle WebLogic<br>• Fake certificates: attackers increasingly use this to evade detection and infiltrate conventional systems. How can we apply what we're learning to protect in the Cloud?<br>What we can do: (5 min)<br>• Countermeasures: <br>o rotate access keys<br>o restrict outbound traffic<br>o cryptojacking blockers for Web browsers<br>• Monitoring user behavior<br>• Follow the principle of least privilege when issuing credentials<br>• EternalBlue is still actively leveraged against vulnerable systems. Think third party compromise<br>• Visibility. Be able to see down to the process level. <br>• Micro-segmentation to control lateral movement and spread <br>• Apply, monitor and enforce best practices<br>• Resources like Yara rules to detect miners (will make available)<br>• Unusual deletions or spinning up containers<br>• IoCs<br>Conclusion and Q&A<br></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default"> <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-1" href="#collapseAshwini" aria-expanded="false" aria-controls="collapseAshwini">
                ...
                <div role="tabpanel" class="tab-pane fade" id="category-2">
                    <div class="panel-group talks-panel-group" id="accordion-2" role="tablist" aria-multiselectable="true">
                        <!--<div class="panel panel-default"> <a class="panel-btn" role="button" data-toggle="collapse" data-parent="#accordion-2" href="#collapseSix" aria-expanded="true" aria-controls="collapseSix"> <div class="panel-heading" role="tab" id="headingSix"> <h4 class="panel-title"> Infrastructure-as-Code for Complete Beginners </h4> <div class="plus-sym"></div></div></a> <div id="collapseSix" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSix"> <div class="panel-body"> <div class="item"> <div class="services__item"> <p class="purple"><strong class="white">Speaker:&nbsp;</strong><strong>Nancy Gariché</strong></p><p class="purple"><strong class="white">Twitter:&nbsp;</strong><a href="https://twitter.com/nanzgtweets" target="_blank"><strong>@nanzgtweets</strong></a></p><p class="white"><strong class="white">Abstract:&nbsp;</strong></p><p class="services__item__text">Ready to take your first steps with Infrastructure-as-Code? During the workshop, we'll learn how to define and manage an infrastructure using a simple, declarative programming language and how to deploy and manage that infrastructure using a few CLI commands. </p><p class="services__item__text">We'll provision an infrastructure including two (2) APIs on two (2) cloud service providers (CSP) using Hashicorp's Terraform and we'll make these two applications communicate.</p><p class="services__item__text"> This workshop is perfect for beginners who have never used Terraform. Take this opportunity to learn-by-doing while you play around in different CSP environments. </p></div></div></div></div></div>-->
                        <!--<div class="panel panel-default"> <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-2" href="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven"> <div class="panel-heading" role="tab" id="headingSeven"> <h4 class="panel-title"> Learning AWS Pentesting with CloudGoat2 </h4> <div class="plus-sym"></div></div></a> <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven"> <div class="panel-body"> <div class="item"> <div class="services__item"> <p class="purple"><strong class="white">Speaker:&nbsp;</strong><strong>Jeff Anderson</strong></p><p class="purple"><strong class="white">Twitter:&nbsp;</strong><a href="https://twitter.com/TheJBAnderson" target="_blank"><strong>@TheJBAnderson</strong></a> </p><p class="white"><strong class="white">Abstract:&nbsp;</strong></p><p class="services__item__text">AWS pentesting is still in its infancy. Newcomers to the field often find it hard to figure out where to start. </p><p class="services__item__text">This workshop will teach AWS pentesting beginners how to approach an AWS environment using the intentionally vulnerable environments provided by CloudGoat2. There will be live demos of setting up the CloudGoat2 environment as well as reconnaissance and exploitation of AWS vulnerabilities that are found in the wild.</p><p class="services__item__text">This talk is rated 101 level with a target audience of penetration testers who are interested in expanding their skillset to include AWS.</p><p class="services__item__text"> Participants are expected to have a basic understanding of penetration testing in general and some experience working with AWS. </p><p class="services__item__text"> Participants will provide their own laptops and will need to have a Free-tier AWS account set up prior to the workshop. </p></div></div></div></div></div>-->
                        <div class="panel panel-default"> <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-2" href="#collapseEight" aria-expanded="false" aria-controls="collapseEight">
                                ...
                                <div class="panel-body">
                                    <div class="item">
                                        <div class="services__item">
                                            ...
                                            <p class="services__item__text">Automating cloud security operations takes a little more than slapping together a quick lambda to fix an open S3 bucket (but that isn't a bad start). In this workshop we will cover the major categories of security automations and present practical implementation techniques. Come prepared to build your own (or use our starter scripts) as we: </p>
                                            <ul class="custom-list">
                                                <li class="white">Review the three major categories of automations- guardrails, workflows, and orchestrations.</li>
                                                <li class="white">Build demo versions of each (in AWS, bring your own account), incorporating techniques including assessments, event-driven guardrails, and an incident response workflow. </li>
                                                <li class="white">See demonstrations of cross-product orchestrations that integrate commercial tools.</li>
                                                <li class="white">Learn the tricks of the trade, based on 10 years of hands-on research and implementation (for realz, check the intertubes if you don't believe us).</li>
                        ...
                        <!--<div class="panel panel-default"> <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-2" href="#collapseNine" aria-expanded="false" aria-controls="collapseNine"> <div class="panel-heading" role="tab" id="headingNine"> <h4 class="panel-title"> Azure Cloud Security Workshop </h4> <div class="plus-sym"></div></div></a> <div id="collapseNine" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingNine"> <div class="panel-body"> <div class="item"> <div class="services__item"> <p class="purple"><strong class="white">Speaker:&nbsp;</strong><strong>Tanya Janca</strong></p><p class="purple"><strong class="white">Twitter:&nbsp;</strong><a href="https://twitter.com/shehackspurple" target="_blank"><strong>@shehackspurple</strong></a> </p><p class="services__item__text">Have you ever wondered how security is different ‘in the cloud'? How is Cloud Security and the "Cloud Native" approach different than a traditional data center? How can you see what's going on with your resources? How do you patch? Where can you see your server configs other important information? How do you manage a security incident? How do you even know that you're having an incident? </p><p class="services__item__text">This workshop has 3 parts:</p><ul class="custom-list"> <li class="white">Group discussion of how cloud native security is different than traditional data centre security</li><li class="white">Demo of Azure Security Centre </li><li class="white">See demonstrations of cross-product orchestrations that integrate commercial tools.</li><li class="white">Audience members investigate issues and mitigate security issues, in Azure, as a group</li></ul> <p class="services__item__text">Demo will include:</p><ul class="custom-list"> <li class="white">Complete Azure Security Centre walkthrough</li><li class="white">Policy and compliance, including subscription coverage </li><li class="white">Resource Security Hygiene</li><li class="white">Azure Security Centre Recommendations (mitigation of one or more items, dependent on time)</li><li class="white">Threat Protection, Alerts and Logging</li><li class="white">Applying System Updates </li></ul> <p class="services__item__text">Audience Participation (people who do not have a laptop can follow along with the teacher)</p><ul class="custom-list"> <li class="white">Load Azure Labs into your trial subscription</li><li class="white">Upgrade Security Centre to "Standard" coverage</li><li class="white">Check your security configurations and settings to ensure your apps are safe </li><li class="white">Implement some of the recommendations</li><li class="white">Force HTTPS</li><li class="white">Turn on Threat protection</li><li class="white">Perform an SQL Injection, then investigate</li><li class="white">More as time permits.</li></ul> <p class="services__item__text">What you will need if you want to participate after the demo:</p><ul class="custom-list"> <li class="white">A laptop running any modern operating system (Mac OS, Windows, Linux)</li><li class="white">Modern web browser (Edge, Chrome, FireFox) </li><li class="white">Wi-fi and internet</li><li class="white">An activated Azure Trial. Please activate your trial before the workshop. The workshop will not wait if you have not activated your trail.</li></ul> <p class="services__item__text">To activate your free Azure trail for this workshop please go here: <a href="https://aka.ms/Azure-Cloud-Security-Workshop" target="_blank">https://aka.ms/Azure-Cloud-Security-Workshop</a> </p><p class="services__item__text">** If you have previously used your free Azure Trail you will not be able to have another one or this workshop.</p><p class="services__item__text">**You will need to use a credit card to activate your trial, but the trial itself is free for 30 days, up to $200. We will use up to $30 of your credit with this workshop.</p></div></div></div></div></div>-->
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade" id="category-3">
                    <div class="panel-group talks-panel-group" id="accordion-3" role="tablist" aria-multiselectable="true">
                        <div class="panel panel-default"> <a class="panel-btn" role="button" data-toggle="collapse" data-parent="#accordion-3" href="#collapseTen" aria-expanded="true" aria-controls="collapseTen">
                                ...
                                <div class="panel-body">
                                    <div class="item">
                                        <div class="services__item">
                                            ...
                                            <ul class="custom-list">
                                                <li class="white">Introductions (2 minutes): A brief introduction to provide our short biographies and a description of our current roles - both speakers</li>
                                                <li class="white">Project background (3 minutes): An overview of how the project came to be, covering previous Splunk work from the DFIR open source community that helped establish the foundations of Sentinel ATT&CK - both speakers</li>
                                                <li class="white">The problem (5 minutes): Although Azure Sentinel contains excellent features – for e.g. threat response automation with Logic Apps (1 minute), a powerful query language (1 minute) and incident grouping (1 minute); the platform offers limited threat hunting capabilities out of the box. Moreover, two major downsides make it difficult to quickly set up a robust, well-structured threat hunting capability; these are a) poor documentation around log onboarding (1 minute) and b) very limited data normalisation features at ingestion time (1 minute) - Edoardo Gerosa</li>
                                                <li class="white">The solution – Sentinel ATT&CK (10 minutes): An overview of the project and how it can help with quickly deploying an effective threat hunting solution for Sentinel – starting with a lighting overview of MITRE ATT&CK (1 minute) , then covering how to configure Sysmon to monitor specific ATT&CK techniques (2 minutes), how to onboard Sysmon logs into Azure (2 minutes), Sentinel parsing best practices (2 minutes), using Kusto to execute hunts (2 minutes) and concluding with an overview of the project's threat hunting dashboard (1 minute) - Edoardo Gerosa</li>
                                                <li class="white">Demo and Q&A session (10 minutes): we'll showcase a live instance of Sentinel ATT&CK deployed on our Azure lab to walk through the functionalities of the platform, execute a demo hunt and, if necessary, to provide practical deep-dives to participant questions - Olaf Hartong</li>
                                            </ul>
                                            <p class="services__item__text">In order to stimulate discussion during the demo and Q&A session we will have three questions in our back-pocket to ask participants; these will be as follows: </p>
                                            <ul class="custom-list">
                                                <li class="white">Who has used Sentinel and what is their opinion of the platform?</li>
                                                <li class="white">Who uses Sysmon as a process monitoring solution in their network and what is their opinion of the tool?</li>
                        ...
                        <div class="panel panel-default"> <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-3" href="#collapseEleven" aria-expanded="false" aria-controls="collapseEleven">
                                ...
                                <div class="panel-body">
                                    <div class="item">
                                        <div class="services__item">
                                            ...
                                            <p class="white"><strong class="white">Abstract:&nbsp;</strong></p>
                                            <p class="services__item__text">Policy as Code Bot (PacBot) is a platform for continuous compliance monitoring, compliance reporting and security automation for the cloud. In PacBot, security and compliance policies are implemented as code. All resources discovered by PacBot are evaluated against these policies to gauge policy conformance. The PacBot auto-fix framework provides the ability to automatically respond to policy violations by taking predefined actions. </p>
                                            <p class="services__item__text">PacBot packs in powerful visualization features, giving a simplified view of compliance and making it easy to analyze and remediate policy violations. PacBot is more than a tool to manage cloud misconfiguration, it is a generic platform that can be used to do continuous compliance monitoring and reporting for any domain.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="panel panel-default"> <a class="panel-btn" class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion-3" href="#collapseTwelve" aria-expanded="false" aria-controls="collapseTwelve">
                                <div class="panel-heading" role="tab" id="headingTwelve">
                                    <h4 class="panel-title"> Rethinking Cloud Security with a Software-Defined Perimeter </h4>
                                    <div class="plus-sym"></div>
                                </div>
                            </a>
                                ...
                                <div class="panel-body">
                                    <div class="item">
                                        <div class="services__item">
                                            ...
                                            <!--<p class="green"><strong class="white">Date:&nbsp;</strong><strong>TBA</strong></p><p class="green"><strong class="white">Time:&nbsp;</strong><strong>TBA</strong></p>-->
                                            <p class="purple"><strong class="white">Twitter:&nbsp;</strong><a href="https://twitter.com/JasonGarbis" target="_blank"><strong>@JasonGarbis</strong></a></p>
                                            <p class="services__item__text">TCP/IP has failed us. Its "implicit trust" philosophy permits anyone to connect to a system before authentication or authorization is applied. And, as we witness daily, the results are not pretty: Not only successful attacks, but ongoing operational headaches and complex toolsets required to manage cloud network access. </p>
                                            <p class="services__item__text">Even today's most advanced Cloud environments rely on TCP/IP, with all its shortcomings, and the widely available Cloud access controls fall short. It's imperative to change the way we approach network security, and adopt a fundamentally more secure, "zero trust" model. We need to realize that the ability to establish a network connection to a system is in fact a privilege, and therefore we must authorize all users before they can do so. This approach hides our systems from all unauthorized users, effectively eliminates DDoS attacks, and dramatically shrinks our network attack surface.</p>
                                            <p class="services__item__text">This session introduces an open model for Cloud network security: the Software-Defined Perimeter (SDP). This security architecture, published by the Cloud Security Alliance, provides a "zero trust" model built with a distributed, scalable, architecture comprising SDP Controller and network Gateways. All network resources remain hidden behind Gateways, unless users are permitted access via real-time policies. The SDP Controller and Gateways themselves are hidden on the network – users must authenticate via a highly efficient, cryptographically secured mechanism – Single Packet Authorization – before a connection to the system is permitted.</p>
                                            <p class="services__item__text">We introduce the SDP technical architecture, and show how it's deployed in a IaaS environment, to secure access to Cloud compute resources. We'll compare and contrast SDP with Cloud-native network security solutions (e.g. Security Groups, Direct Connect) as well as traditional security solutions (e.g. VPNs), and explain why SDP is superior. After a brief demonstration, we will conclude with a reference architecture for SDP in cloud environments.</p>
                                            <p class="services__item__text">Join us to learn why and how SDP literally makes network resources invisible to unauthorized users.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div role="tabpanel" class="tab-pane fade" id="category-4">
                    <div class="panel-group talks-panel-group" id="accordion-4" role="tablist" aria-multiselectable="true">
                        <div class="panel panel-default"> <a class="panel-btn" role="button" data-toggle="collapse" data-parent="#accordion-4" href="#collapseThirteen" aria-expanded="true" aria-controls="collapseThirteen">
                                ...
                                <div class="panel-body">
                                    <div class="item">
                                        <div class="services__item">
                                            ...
                                            <p class="white"><strong class="white">Abstract:&nbsp;</strong></p>
                                            <p class="services__item__text">Learn about a breach, what happens in the aftermath and why I can't tell my peers what happen. Learn the fallout and more importantly what application developers aren't thinking about. </p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div role="tabpanel" class="tab-pane fade in active" id="day-1">
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Setting Up The Village </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Opening Note 15 + 5 minutes </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Keynote 35 + 5 Minutes </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseOne">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Colin Estep - Exploiting IAM in the Google Cloud Platform </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseDani">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Dani Goland, Mohsan - Battle in the Clouds: Attacker vs Defender on AWS </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseTen">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Edoardo Gerosa - ATT&CKing the Sentinel – deploying a threat hunting capability on Azure Sentinel using Sysmon and MITRE ATT&CK </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseThirteen">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Jane Miceli - Security Battle Wounds from a Cloud SRE </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseEight">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Rich Mogull - Pragmatic Cloud Security Automation </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade in" id="day-2">
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Registration & Village Setup </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseThree">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Chris le roy - Build to Hack, Hack to Build </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseFive">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Ayman Elsawah - Applying Pareto's Principle for Securing AWS with SCPs </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Lightening Talk (20 minutes +5) </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseEleven">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Setu Parimi - PacBot - Policy as Code from T-Mobile OSS </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseTwo">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Rotem Bar - Hacking into automotive clouds </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseTanya">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Tanya Janca - DYI Azure Security Assessment </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseRod">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Rod Soto - Using Splunk for Auditing AWS/GCP/Azure Security posture </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseJames">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> James Strassburg - Scaling Security in the Cloud With Open Source </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseFour">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Erick Galinkin - Your Blacklist is Dead: Why the Future of Command and Control is the Cloud </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Andrew Krug - MozDef </p>
                            </div>
                        </div>
                    </div>
                </div>
                <div role="tabpanel" class="tab-pane fade in" id="day-3">
                    ...
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseCheryl">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Cheryl Biswas - Mining Malevolence: Cryptominers in the Cloud </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Josh Mize - Securing Multi-cloud Kubernetes </p>
                            </div>
                        </div>
                    </div>
                    <div class="schedule-item dashed-line r-mb-2 r-mt-2" data-id="collapseAshwini">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9 vertical-line">
                                <p class="green"> Ashwin Vamshi, Abhinav Singh - Phishing in the cloud era </p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="works__header">
                    ...
                    <nav class="works__header__nav col-xs-12 col-sm-9"> <button data-filter="*" class="works__nav__item works__nav__item_active"><span class="works__button_underline"></span>All</button> <button data-filter=".1st-quarter" class="works__nav__item"><span class="works__button_underline"></span>1st quarter</button> <button data-filter=".2nd-quarter" class="works__nav__item"><span class="works__button_underline"></span>2nd quarter</button> <button data-filter=".3rd-quarter" class="works__nav__item"><span class="works__button_underline"></span>3rd quarter</button> <button data-filter=".4th-quarter" class="works__nav__item"><span class="works__button_underline"></span>4th quarter</button> </nav>
                </div>
            </div>
            <div class="gallery">
                <div class="gallery__items">
                    <div class="gallery__item gallery__item_1 col-xs-12 col-sm-6 1st-quarter">
                        <div class="gallery__item__hover"> <span class="item__hover__line"></span><span class="item__hover__tag">09th - 11th August, 2019</span>
                            <h3 class="item__hover__header"><a href="https://docs.google.com/forms/d/e/1FAIpQLSeGxSDgynvAv7Q1dTPeobZUPo5jdlbrcNSQAYVLgRqCF6T0bg/viewform" target="_blank" title="CFP for DEF CON 27">CFP for Talks/Workshops/Tool Demo Open</a></h3>
                            <h4 class="item__hover__header-small">DEF CON 27, Las Vegas, Nevada</h4> <a href="https://docs.google.com/forms/d/e/1FAIpQLSeGxSDgynvAv7Q1dTPeobZUPo5jdlbrcNSQAYVLgRqCF6T0bg/viewform" target="_blank" class="item__hover__zoom" title="CFP for DEF CON 27"> +&nbsp;More </a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="clients__header row">
                ...
                <div class="col-xs-12 col-md-12">
                    ...
                    <!--<p class="text__par">Below is the list of possible benefits we can provide to our Sponsors: </p>--> <a href="https://docs.google.com/forms/d/e/1FAIpQLSfIlR_-GZ_WqAwu64AobwRPdaiqw8DZusjTPNm4bVoOtH2k3g/viewform" target="_blank" class="text__button inline-btn" title="Become a sponsor">Become a sponsor</a>
                </div>
            </div>
    ...
    <script>
        /*items_set=[{filter: 'design', backgroundImage: 'images/photos/laptop.jpg', tagName: 'Design', headingHref: 'javascript:void', heading: 'Laptop and keyboard', headingSmall: 'Awesome typing', img: 'images/magnificpopup/redstrip.jpg', title: 'Just simple block'},{filter: 'identy', backgroundImage: 'images/photos/cookie.jpg', tagName: 'Identy', headingHref: 'javascript:void', heading: 'Cookie and Coffee', headingSmall: 'Take a break', img: 'images/magnificpopup/cookie.jpg', title: 'Coffee Web Site'},{filter: 'web', backgroundImage: 'images/photos/essentials.jpg', tagName: 'Web Design', headingHref: 'javascript:void', heading: 'Magazines', headingSmall: 'Nice reading', img: 'images/magnificpopup/essentials.jpg', title: 'Coffee Web Site'},{filter: 'identy', backgroundImage: 'images/photos/softs.jpg', tagName: 'Identy', headingHref: 'javascript:void', heading: 'Sheets of paper', headingSmall: 'Getting correct information', img: 'images/magnificpopup/softs.jpg', title: 'Coffee Web Site'},]; $('.gallery__items').portfolio_addon({load_count: 2, items: items_set});*/
    </script>
</body>
